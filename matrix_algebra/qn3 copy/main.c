//will it be useful to have a code for matrix scalar maultiplication?
//determine the matrix inverse
//solve this system using the matrix inverse
#include<stdio.h>
#include<stdlib.h>
#include<math.h>
...
void lu_decomposition_without_pivoting(float **array, int n)
{
    for(int k=0;k<n-1;k++)
    {
...
//the array here is input after being LU decomposed
...
int main()
{
    ...
    //write down the explanantion for why matrix inverse calculation is not possible in this case
//    matrix_inverse(array, inverse, n);
//    //return the elements of the inverse
//    printf("the elements of the inverse matrix are :\n");
//    for(int i=0;i<n;i++)
//    {
//        for(int j=0;j<n;j++)
//        {
...
//    //the values of the variables obtained by using matrix inverse are;
//    for(int i=0;i<n;i++)
//    {
//        float sum=0;
//        for(int j=0;j<n;j++)
