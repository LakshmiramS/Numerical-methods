//this code should input the real and imaginary parts of the coefficient matrices to spit out the real and imaginary parts of the answer.
#include<stdio.h>
#include<stdlib.h>
#include<math.h>
...
int main()
{
    ...
    for(int i=0;i<n;i++)
    {
        for(int j=0;j<n;j++)
        {
            printf("enter the real part of array[%d][%d]  ",i+1,j+1);
            scanf("%f",&array[i][j]);
        }
        printf("\n");
    }
